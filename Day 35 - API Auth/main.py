...
def check_weather_for_rain():
    ...
    elif moderate_rain_count >= 5 and avg_intensity_over_next30 >= 6 and pop_value['pop'] >= 0.50:
    ...
    elif light_rain_count >= 5 and avg_intensity_over_next30 >= 2 and pop_value['pop'] >= 0.20:
